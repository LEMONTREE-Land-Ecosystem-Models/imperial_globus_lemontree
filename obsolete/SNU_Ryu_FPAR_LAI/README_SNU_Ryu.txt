MODIS LAI:  2000-2017, daily
MODIS fPAR: 2000-2019, daily

Both data were interpolated to daily step from their original 8-day step.
...
We saved the 0.05 degree data as one-dimension data to reduce its size. The land cover map can
help to convert them to two-dimension global map (3660 pixel * 7200 pixel). 

Below is the matlab script for generating gridded 0.05 degree map with geographic lat/lon projection

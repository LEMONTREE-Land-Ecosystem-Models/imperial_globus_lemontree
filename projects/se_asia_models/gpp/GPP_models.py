...
co2_data = pandas.read_csv(co2_path, comment="#")
co2_data = co2_data.query(f"year=={year}")["average"].to_numpy()
...
# Load the CHELSA variables for the model and correct units. There may be a way to load
# these using an xarray multifile dataset, but the inputs lack an explicit time
# dimension on which to concatenate the files.
...
# NOTE: The string formatting here is requires a placeholder '{year}' for the year and
#       then a placeholder '{month:02d}' for the function to iterate over the months as
#       '01' to '12'

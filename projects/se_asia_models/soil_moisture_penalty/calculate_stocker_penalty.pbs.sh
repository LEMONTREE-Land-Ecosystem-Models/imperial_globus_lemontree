...
# Calculate the aridity index and Stocker penalty factor
...
#PBS -j oe
#PBS -o /rds/general/project/lemontree/live/projects/se_asia_models/soil_moisture_penalty/calculate_stocker_penalty.out
...
# Run the GPP script
python /rds/general/project/lemontree/live/projects/se_asia_models/soil_moisture_penalty/calculate_stocker_penalty.py
